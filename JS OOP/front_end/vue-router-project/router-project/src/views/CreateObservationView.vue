<template>
  <div class="createObservation">
    <h1>Observation Template create observation view</h1>
    <div class="card" style="padding: 5px">
      ...
      <div class="card-body">
        ...
        <div class="row my-2">
          ...
          <div class="col-3">
            <label class="form-label mt-2">Oktas</label>
          </div>
        </div>
        <div class="row my-2">
          <div class="col-3">
          ...
          <ul class="list-group">
            <li
              ...
              v-for="(cloudLayer, cloudLayerIndex) in this.observation
                .cloudLayers"
            >
              Cloud type: {{ this.observation.cloudLayers[cloudLayerIndex].type }} -
              Height: {{ this.observation.cloudLayers[cloudLayerIndex].height }}ft -
